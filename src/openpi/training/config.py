...
class DataConfig:
    ...
    # Optional RECAP sidecar fields generated by scripts/label_recap_advantage.py.
    # The file must contain advantage_indicator, use_advantage, and is_human_intervention arrays
    # with the same flattened frame order as the LeRobot dataset.
